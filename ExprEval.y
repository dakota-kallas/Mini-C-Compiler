...
Dec			      :	Int Id ';'	                                                  { createVariable(table, $2, "int"); };
              ...
              | Int Id '[' DecIntLit ']' '[' DecIntLit ']' ';'                { create2DArray($2, $4, $7); };
...
Stmt			    :	Print '(' ExprList ')' ';'					                          { $$ = doPrintExpressionList($3); };
              ...
              | Id '[' BExprL0 ']' '[' BExprL0 ']' '=' BExprL0 ';'						{ $$ = do2DArrayAssign($1, $3, $6, $9); };
...
Factor		    :	IntLit									                                      { $$ = doIntLit(yytext); };
              ...
              |	Id '[' BExprL0 ']' '[' BExprL0 ']'									          { $$ = do2DArrayRval($1, $3, $6); };
              |	Id '[' BExprL0 ']'									                          { $$ = doArrayRval($1, $3); };
              |	Id									                                          { $$ = doRval($1); };
ParamList     : Id '[' BExprL0 ']' '[' BExprL0 ']' ',' ParamList              { $$ = doRead2DArray($1, $3, $6, $9); };
              | Id '[' BExprL0 ']' '[' BExprL0 ']'                            { $$ = doRead2DArray($1, $3, $6, NULL); };
              | Id '[' BExprL0 ']' ',' ParamList                              { $$ = doReadArray($1, $3, $6); };
